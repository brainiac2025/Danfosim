...
Watch a simulated day, vehicle by vehicle: [interactive dashboard](https://claude.ai/artifact/WDKRwNcBMUrRYhy4aZDKQn) (generated by `scripts/export_trace.py` + `docs/dashboard.html`).
